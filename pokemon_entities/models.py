...
class Pokemon(models.Model): 
    ...
    photo = models.ImageField(verbose_name="картинка", null=True, blank=True) 
...
class PokemonEntity(models.Model): 
    pokemon_model = models.ForeignKey(Pokemon,verbose_name='покемон', on_delete=models.CASCADE,related_name='entities') 
    ...
    attack = models.IntegerField(verbose_name='сила атаки', null=True, blank=True)
